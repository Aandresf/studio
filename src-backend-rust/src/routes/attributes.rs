...
async fn get_attributes(pool: web::Data<DbPool>) -> impl Responder {
...
async fn get_attribute(path: web::Path<i64>, pool: web::Data<DbPool>) -> impl Responder {
...
async fn create_attribute(attribute: web::Json<NewAttribute>, pool: web::Data<DbPool>) -> impl Responder {
...
async fn update_attribute(path: web::Path<i64>, attribute: web::Json<UpdateAttribute>, pool: web::Data<DbPool>) -> impl Responder {
    let attribute_id = path.into_inner();
...
async fn delete_attribute(path: web::Path<i64>, pool: web::Data<DbPool>) -> impl Responder {
    let attribute_id = path.into_inner();
...
async fn search_attributes(path: web::Path<String>, pool: web::Data<DbPool>) -> impl Responder {
...
async fn get_attribute_values(path: web::Path<i64>, pool: web::Data<DbPool>) -> impl Responder {
    let attribute_id = path.into_inner();
...
async fn create_attribute_value(path: web::Path<i64>, value: web::Json<NewAttributeValue>, pool: web::Data<DbPool>) -> impl Responder {
    let attribute_id = path.into_inner();
