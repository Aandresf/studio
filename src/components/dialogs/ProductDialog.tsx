    ...
    try {
      switch (quickAddType) {
        ...
        case 'attribute':
          ...
          // Después de crear un atributo, recargamos respetando la configuración de atributos globales
          // (no forzamos la inclusión de globales si la tienda no lo permite).
          await fetchAttributes(productBase.subdepartment_id || null, enableGlobalAttributes);
          break;
        case 'attributeValue':
