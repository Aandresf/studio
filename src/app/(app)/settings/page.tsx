...
import { SSLCertificatesCard } from './components';
...
function SSLCertificatesCard() {
    ...
    useEffect(() => {
        ...
        const getConfiguredIp = async () => {
            try {
                ...
                toastError("Error", "No se pudo obtener la IP configurada");
            }
        };
        getConfiguredIp();
    }, []);
    ...
    const handleGenerateCertificate = async () => {
        ...
        try {
            ...
            toastSuccess("Éxito", "Certificados generados correctamente");
            ...
            toastError("Error", "No se pudieron generar los certificados");
        } finally {
    ...
    <div className="flex flex-col gap-6">
      <div className="space-y-6">
        <div className="flex-1">
          ...
          <p className="text-sm text-muted-foreground">Gestiona tus tiendas, certificados SSL y apariencia de la aplicación.</p>
        </div>
