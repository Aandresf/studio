...
function ProductDialog({ open, onOpenChange, product, onProductSaved }) {
    ...
    const handleGenerateVariants = ()=>{
        ...
        if (arraysOfSelectedValues.every((arr)=>arr.length === 0)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toastError"])("Aviso", "Selecciona al menos un valor.");
            return;
        }
...
//# sourceMappingURL=src_ac1f8d3b._.js.map