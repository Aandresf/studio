...
function sortPermissions(list, category) {
    ...
    const orderKeys = [
        ...
        'departments:subdepartments:create',
        'departments:subdepartments:edit',
        'departments:subdepartments:delete',
        'brands:create',
        'brands:edit',
        'brands:delete',
        'attributes:create',
...
function PermissionsEditor({ user, onClose, onSave }) {
    ...
    const groupedRaw = groupByCategory(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissionsMeta$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["PERMISSIONS_META"]);
...
//# sourceMappingURL=src_2628fe4c._.js.map