...
const PERMISSIONS_META = (__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$json__$28$json$29$__["default"].permissions || []).map(_c = (p)=>{
...
var _c, _c1;
__turbopack_context__.k.register(_c, "PERMISSIONS_META$(permissionsJson.permissions || []).map");
__turbopack_context__.k.register(_c1, "PERMISSIONS_META");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
function SettingsPage() {
    ...
    // Sync / QR state
    const [syncUrl, setSyncUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    ...
    const [serverInfo, setServerInfo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    // base URL for backend API (can be set at build time)
    const apiBaseRaw = (__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL || '').replace(/\/$/, '');
    const apiPrefix = apiBaseRaw || '';
    const [resolvedApiPrefix, setResolvedApiPrefix] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(apiPrefix);
    const handleCopyLink = async ()=>{
        try {
            await navigator.clipboard.writeText(syncUrl);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastSuccess"])('Copiado', 'Enlace copiado al portapapeles');
        } catch (e) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])('Error', 'No se pudo copiar al portapapeles');
        }
    };
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SettingsPage.useEffect": ()=>{
            let mounted = true;
            const setup = {
                "SettingsPage.useEffect.setup": async ()=>{
                    const tryFetchServerInfo = {
                        "SettingsPage.useEffect.setup.tryFetchServerInfo": async (base)=>{
                            try {
                    ...
                    }["SettingsPage.useEffect.setup.tryFetchServerInfo"];
                    ...
                    if (found && mounted) {
                        ...
                        const base = info?.frontendOrigin ? info.frontendOrigin : info?.ip ? `http://${info.ip}:${info.port}` : info?.url || (("TURBOPACK compile-time truthy", 1) ? window.location.origin : ("TURBOPACK unreachable", undefined));
                    ...
                    const fallback = ("TURBOPACK compile-time truthy", 1) ? (window.location?.origin || '') + '/' : ("TURBOPACK unreachable", undefined);
                    setSyncUrl(fallback);
                    const qrSrc = apiPrefix || '' ? `${(apiPrefix || '').replace(/\/$/, '')}/api/qr?data=${encodeURIComponent(fallback)}` : `/api/qr?data=${encodeURIComponent(fallback)}`;
                    setQrDataUrl(qrSrc);
                }
            }["SettingsPage.useEffect.setup"];
            setup();
            return ({
                "SettingsPage.useEffect": ()=>{
                    mounted = false;
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$label$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Label"], {
                                                            htmlFor: "enableGlobalAttributes",
                                                            className: "text-base",
                                                            children: "Habilitar gestión global de Marcas y Atributos"
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(app)/settings/page.tsx",
                                                            lineNumber: 600,
                                                            columnNumber: 29
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            className: "text-sm text-muted-foreground",
                                                            children: "Cuando está activo, se muestran las secciones para administrar Marcas y Atributos a nivel global."
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/(app)/settings/page.tsx",
                                                            lineNumber: 601,
                                                            columnNumber: 29
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$switch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Switch"], {
                                                    ...
                                                    onCheckedChange: (checked)=>handleAdvancedChange('enableGlobalAttributes', checked),
                                                    disabled: !canManageAdvanced
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(app)/settings/page.tsx",
                                                    lineNumber: 605,
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                                            children: "Sincronización - Accede desde un móvil"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/settings/page.tsx",
                                            lineNumber: 690,
                                            columnNumber: 41
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardDescription"], {
                                            children: "Escanea el código QR con tu teléfono para abrir la aplicación web desde la red local."
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/settings/page.tsx",
                                            lineNumber: 691,
                                            columnNumber: 41
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                    ...
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-sm text-muted-foreground",
                                            children: "Enlace generado (editable):"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/settings/page.tsx",
                                            lineNumber: 696,
                                            columnNumber: 41
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    ...
                                                    children: "Si tu móvil y el equipo están en la misma red local, el QR abrirá la página directamente."
                                                }, void 0, false, {
                                                    fileName: "[project]/src/app/(app)/settings/page.tsx",
                                                    lineNumber: 710,
                                                    columnNumber: 45
...
_s2(SettingsPage, "EJZWKevbs+YFlLvD2X9MHMQadwk=", false, function() {
    return [
...
//# sourceMappingURL=src_78de39fe._.js.map