...
async function fetchAPI(endpoint, options = {}) {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            Body: ${responseBody}
            ------------------------`);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])("Error de API", errorMessage);
...
//# sourceMappingURL=src_4db15031._.js.map