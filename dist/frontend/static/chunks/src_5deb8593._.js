...
;
;
function Combobox({ options, value, onChange, placeholder = "Select an option...", searchPlaceholder = "Search...", emptyMessage = "No options found.", className, disabled = false, open: controlledOpen, onOpenChange: setControlledOpen, popoverClassName, renderHeader, renderOption, sideOffset = 4, align = "center" }) {
    _s();
    ...
    const filteredOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Combobox.useMemo[filteredOptions]": ()=>{
            if (!searchValue) return options;
            return options.filter({
                "Combobox.useMemo[filteredOptions]": (option)=>option.label.toLowerCase().includes(searchValue.toLowerCase())
            }["Combobox.useMemo[filteredOptions]"]);
        }
    }["Combobox.useMemo[filteredOptions]"], [
        options,
    ...
    const selectedLabel = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Combobox.useMemo[selectedLabel]": ()=>{
            return options.find({
                "Combobox.useMemo[selectedLabel]": (option)=>option.value === value
            }["Combobox.useMemo[selectedLabel]"])?.label;
        }
    }["Combobox.useMemo[selectedLabel]"], [
        options,
        value
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "truncate",
                            children: value ? selectedLabel : placeholder
                        }, void 0, false, {
...
_s(Combobox, "MzcCIKB1DfWqXsHPYvPGrkkOXuY=");
_c = Combobox;
var _c;
...
function PurchasesPage() {
    ...
    const productOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "PurchasesPage.useMemo[productOptions]": ()=>products.map({
                "PurchasesPage.useMemo[productOptions]": (p)=>({
                        value: String(p.id),
                        label: p.name
                    })
            }["PurchasesPage.useMemo[productOptions]"])
    }["PurchasesPage.useMemo[productOptions]"], [
        products
    ]);
    const resetForm = ()=>{
...
_s(PurchasesPage, "Q36rDPlpD+U0ANrblCwogbgq2tM=", false, function() {
    return [
...
//# sourceMappingURL=src_5deb8593._.js.map