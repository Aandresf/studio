...
function ProductDialog({ open, onOpenChange, product, onProductSaved }) {
    ...
    const fetchBrands = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ProductDialog.useCallback[fetchBrands]": async ()=>{
            setBrands(await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrands"])());
        }
    }["ProductDialog.useCallback[fetchBrands]"], []);
    ...
    const handleQuickSave = async (values)=>{
        ...
        try {
            switch(quickAddType){
                case 'brand':
                    newItem = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createBrand"])({
                        name: values.name
                    });
                    await fetchBrands();
                    setProductBase((p)=>({
...
_s(ProductDialog, "NJLWHImvlwEkkdH2DOQzC0k53gA=");
_c = ProductDialog;
var _c;
