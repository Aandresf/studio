...
function SalesPage() {
    ...
    const productOptions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "SalesPage.useMemo[productOptions]": ()=>products.map({
                "SalesPage.useMemo[productOptions]": (p)=>({
                        value: String(p.id),
                        label: p.name
                    })
            }["SalesPage.useMemo[productOptions]"])
    }["SalesPage.useMemo[productOptions]"], [
        products
    ]);
    const resetForm = ()=>{
...
_s(SalesPage, "gfbQT9c2ZrJTGaXGBXiwscvuol0=", false, function() {
    return [
...
//# sourceMappingURL=src_630bd225._.js.map