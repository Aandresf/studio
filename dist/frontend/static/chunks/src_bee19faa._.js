...
function ProductDialog({ open, onOpenChange, product, onProductSaved }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ProductDialog.useEffect": ()=>{
            if (open) {
                const fetchData = {
                    "ProductDialog.useEffect.fetchData": async ()=>{
                        setIsLoading(true);
                        try {
                            const [brandsData, attributesData] = await Promise.all([
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getBrands"])(),
                                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getAttributes"])()
                            ]);
                ...
                }["ProductDialog.useEffect.fetchData"];
                fetchData();
            }
        }
    }["ProductDialog.useEffect"], [
    ...
    const handleAttributeSelection = async (attr)=>{
        ...
        if (selectedAttributes[attributeId]) {
            ...
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])("Error", `No se pudieron cargar los valores para ${attr.name}`);
            }
        }
    };
    ...
    const handleGenerateVariants = ()=>{
        ...
        if (arraysOfSelectedValues.every((arr)=>arr.length === 0)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])("Aviso", "Selecciona al menos un valor para generar variantes.");
            return;
        }
    ...
    const handleSave = async ()=>{
        if (!productBase.name) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])("Validación", "El nombre del producto es obligatorio.");
            return;
        }
        if (variants.length === 0) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastError"])("Validación", "Debes generar al menos una variante para el producto.");
            return;
        }
        const payload = {
            ...productBase,
        ...
        try {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$toast$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toastSuccess"])("Éxito", "Producto guardado correctamente.");
...
_s(ProductDialog, "az51GqX0D2KyogBtsNpRfOyeXmk=");
_c = ProductDialog;
var _c;
...
//# sourceMappingURL=src_bee19faa._.js.map